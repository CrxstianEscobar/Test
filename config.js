...
global.imagen1 = fs.readFileSync('./src/assets/images/menu/languages/es/allmenu.png');
global.imagen2 = fs.readFileSync('./src/assets/images/menu/languages/pt/allmenu.png');
...
global.imagen6 = fs.readFileSync('./src/assets/images/menu/main/menuaudios.png')
global.imagen7 = fs.readFileSync('./src/assets/images/menu/main/menulogos.png')
global.imagen8 = fs.readFileSync('./src/assets/images/menu/main/menuowner.png')
global.imagen9 = fs.readFileSync('./src/assets/images/menu/main/menurec.png')
...
global.fgif = {key: {participant: '0@s.whatsapp.net'}, message: {'videoMessage': {'title': wm, 'h': `Hmm`, 'seconds': '999999999', 'gifPlayback': 'true', 'caption': bottime, 'jpegThumbnail': fs.readFileSync('./src/assets/images/menu/languages/es/allmenu.png')}}};
